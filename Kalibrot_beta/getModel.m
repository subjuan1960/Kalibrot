...
while(err > Err && iter < Iter)
    ...
    DH_params(2:5:end,1) = atan2(sin(DH_params(2:5:end,1)),cos(DH_params(2:5:end,1)));
    DH_params(4:5:end,1) = atan2(sin(DH_params(4:5:end,1)),cos(DH_params(4:5:end,1)));
